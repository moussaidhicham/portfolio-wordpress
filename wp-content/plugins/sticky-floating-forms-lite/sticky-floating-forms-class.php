...
if ( !class_exists( 'Sticky_Floating_Forms_Lite' ) ):
    ...
    class Sticky_Floating_Forms_Lite {
        ...
        public function __construct() {
            ...
            add_action( 'admin_notices', array( $this,'plugin_upgrade_notice') );
            add_action( 'wp_ajax_plugin_ajax_notice_handler', array( $this,'plugin_ajax_notice_handler') );
        ...
        */
        function load_admin_scripts() {
            ...
            $localize_options =  array(
                'ajaxurl'       => admin_url( 'admin-ajax.php'),
                'ajax_nonce'    => wp_create_nonce('sticky-floating-forms-cww')
                );
        ...
        function plugin_upgrade_notice(){

            if ( get_option('dismissed-notice-upgrade-sffp-cww-pro', FALSE ) ) { 
                return;
            }
            
            if(! class_exists('Sticky_Floating_Forms_Pro') ){
                ?>
                <div class="notice-upgrade-sffp updated notice is-dismissible" data-notice="notice-upgrade-sffp-cww-pro">
                    <p>
                        <?php esc_html_e('Check Sticky Floating Forms Pro for more stunning functions and features.','sticky-floating-forms-lite')?>
                    </p>
                    <p class="actions">
                        <a href="https://codeworkweb.com/wordpress-plugins/sticky-floating-forms/" target="_blank" ><?php echo esc_html__('View Details','sticky-floating-forms-lite'); ?></a>
                    </p>
                </div>
                <?php 
            }
         ...
         */
        function plugin_ajax_notice_handler() {

            
            if( check_ajax_referer( 'sticky-floating-forms-cww', $_POST['security'], false ) ){
                return;
            }
